...
extension ViewController: UISearchResultsUpdating
{
    func updateSearchResults(for searchController: UISearchController)
    {
        ...
        //MARK: Swifty way of searching(non-literal)
        //Filter through the countries
        
        self.searchArray = Countries.list.filter({ (country: String) in
            
            return country.lowercased().contains(self.countrySearchController.searchBar.text!.lowercased())
        })
        countryTable.reloadData()
    }
}
